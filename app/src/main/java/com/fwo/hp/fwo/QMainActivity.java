...
public class QMainActivity extends AppCompatActivity {
    ...
    public  static String fullurl,l_address;
    String extra="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(gps.canGetLocation()){
            ...
            if (nwLocation != null) {
                ...
                lat = String.valueOf(latitude);
                longi = String.valueOf(longitude);
                l_address="http://maps.google.com/maps?q=" + lat + "," +  longi;
            } else {
    ...
    class async extends AsyncTask<Object,Void,String> {
        ...
        protected void onPostExecute(String st) {
            ...
            if (temp == null) {
                Toast.makeText(QMainActivity.this,"error", Toast.LENGTH_LONG).show();
            } else {
                ...
                myadapter = new mAdapter(QMainActivity.this,name,open,vicinity);
