...
String code;
    ...
    private static String KEY_CREATED_AT = "otp";
...
boolean flag=false;
    ...
    private DatabaseHandler db;
     public static String str_num,str_code,str_name;
    String lat,longi;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
          ...
          /*  lat=getIntent().getStringExtra("lat");
            ...
            //Toast.makeText(getApplicationContext(),"lat"+lat+"longi"+longi,Toast.LENGTH_LONG).show();
            startActivity(i);
            finish();
        }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        str_num=json_user.getString(KEY_EMAIL);
                        str_code=json_user.getString(KEY_CREATED_AT);
                        str_name=json_user.getString(KEY_NAME);
                        ...
                        if(Integer.parseInt(json_user.getString("verified")) == 1){
                            ...
                            Intent upanel = new Intent(LoginActivity.this, Navigation.class);
