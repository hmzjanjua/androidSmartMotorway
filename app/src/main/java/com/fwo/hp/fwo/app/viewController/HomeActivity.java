package com.fwo.hp.fwo.app.viewController;
...
import com.fwo.hp.fwo.app.entity.TodayEntity;
import com.fwo.hp.fwo.app.model.Channel;
import com.fwo.hp.fwo.app.model.Forecast;
import com.fwo.hp.fwo.app.provider.yahooWeather.WeatherServiceCallback;
import com.fwo.hp.fwo.app.provider.yahooWeather.YahooWeatherService;
import com.fwo.hp.fwo.app.utils.Prefs;
import com.fwo.hp.fwo.app.viewController.adapter.HomeForecastAdapter;
...
//        viewBinding.setToday(new TodayEntity(getApplicationContext(), channel));
    ...
    private void loadTodayInfo(TodayEntity te){
        ...
        locationTextView.setText(te.getLocal(true));
