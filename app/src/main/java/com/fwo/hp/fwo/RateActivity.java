...
public class RateActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        btnChangePass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(RateActivity.this);
    ...
    public void srch(View v){
        Intent i=new Intent(this,QMainActivity.class);
...
//    String src=space(sr);
    ...
    public void res(View v){
        Intent i=new Intent(this,QMainActivity.class);
        i.putExtra("EXTRA", "&name=resturant");
        startActivity(i);
    }
    public void ban(View v){
        Intent i=new Intent(this,QMainActivity.class);
        i.putExtra("EXTRA", "&name=toll plaza");
        startActivity(i);
    }
    public void hot(View v){
        Intent i=new Intent(this,QMainActivity.class);
        i.putExtra("EXTRA","&name=rest areas");
        startActivity(i);
    }
