...
btn_c=(Button)findViewById(R.id.btn_code);
        ...
        smsManager.sendTextMessage(LoginActivity.str_num, null, "Your verification code is " + LoginActivity.str_code, null, null);
        Toast.makeText(EmailVerify.this,"Your Code Sent Successfully",Toast.LENGTH_LONG).show();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent upanel = new Intent(EmailVerify.this, Navigation.class);
